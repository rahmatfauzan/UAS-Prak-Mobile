...
import 'package:motor/register.dart';
...
class _LoginState extends State<Login> {
  ...
  void login() async {
    ...
    if (user != null) {
      MyUser? loggedInUser = await Database.getUser(email: email);

      if (loggedInUser != null) {
        if (loggedInUser.kategori == "user") {
          ...
          print("BISAAAAAAAAAAAAAAAAAA");
          Navigator.of(context).pushReplacementNamed('/home');
        } else if (loggedInUser.kategori == "admin") {
          print("BISAAAAAAAAAAAAAAAAAA");
